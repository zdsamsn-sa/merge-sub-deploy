...
@app.function(
    ...
    # IMPORTANT: Create this secret BEFORE deploy, or deploy will fail:
    #   modal secret create merge-sub-secrets USERNAME=xx PASSWORD=xx SUB_TOKEN=xx
    # Or open: Modal Console → Secrets → name must be exactly "merge-sub-secrets"
